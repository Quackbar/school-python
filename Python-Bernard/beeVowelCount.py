word = '''Bee Movie Script - Dialogue Transcript
...
for i in range(len(word)):
    ...
    for e in range(len(alphabet)):
        if(word[i].lower() == alphabet[e]):
            alphabetNum[e] = alphabetNum[e] + 1
        e = e+1
           

print('The Bee Movie Script has ' + str(charCount) + ' characters, ' + str(vowelCount) + ' are vowels and ' + str(consCount) + ' are consonants')
for i in range(len(alphabet)):
    print(alphabet[i] + ' = ' + str(alphabetNum[i]))
    i = i+1
